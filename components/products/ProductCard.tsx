  ...
  return (
    <div className="rounded bg-white shadow relative p-5">
      ...
      {isAvailable(product.inventory) ? (
        ...
        <p className="avsolute top-1/2 left-1/2 transform -transalate-x-1/2 -translate-y-1/2 bg-white opacity-60 w-full text-center py-5 text-2xl uppercase font-black">
          Agotado
        </p>
      )}
    </div>
